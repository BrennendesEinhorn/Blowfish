...
public class WIPMove : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        Vector3 rot = Vector3.RotateTowards(rBody.velocity, direction * rBody.velocity.magnitude, 7, 1);
        Quaternion rotation = Quaternion.Euler(rot);
        rBody.velocity = rotation * rBody.velocity;
    }
